        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          <Reveal as="div" className="max-w-3xl">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif text-brand-charcoal leading-tight mb-6">
              Sage Futures: Nonprofit Community Development Corporation
            </h1>
            <p className="text-lg md:text-xl text-brand-charcoal/85 leading-relaxed font-light max-w-2xl">
              Advancing community impact through mission-first programs, capacity building, and public-benefit initiatives.
            </p>
            <div className="mt-10 flex flex-col sm:flex-row gap-6">
              ...
              <Link
                to="/partnerships"
                className="bg-brand-brass text-white px-10 py-5 text-center text-xs font-bold uppercase tracking-widest hover:bg-brand-sage transition-all duration-300 shadow-sm transform hover:-translate-y-0.5 active:translate-y-0"
              >
                Partner With Us
              </Link>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal as="div" className="space-y-6">
            <p className="text-base md:text-lg text-brand-charcoal/75 leading-relaxed">
              Sage Futures is a nonprofit CDC dedicated to community development, capacity building, and systems change. Our work centers on strengthening institutions, empowering communities, and advancing public benefit.
            </p>
            <p className="text-base md:text-lg text-brand-charcoal/75 leading-relaxed">
              We partner with organizations and communities to build durable, values-aligned structures—where care, capital, and coordination foster collective impact.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <section className="py-24 bg-brand-offwhite">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Reveal as="div" className="grid md:grid-cols-2 gap-6 text-sm md:text-base text-brand-charcoal/80">
            ...
            <ul className="space-y-3 list-disc list-inside">
              <li className="transition-colors duration-200 hover:text-brand-sage">Grant Readiness & Capital Access</li>
              <li className="transition-colors duration-200 hover:text-brand-sage">Revenue Diversification</li>
