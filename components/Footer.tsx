      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-12 items-start">
          <div className="md:col-span-5">
            <Link to="/" className="group inline-flex items-center gap-4 mb-8">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-[10px] tracking-[0.4em] text-brand-stone/60 uppercase font-medium mt-2">Systems & Economic Advisory</p>
              </div>
            </Link>
          ...
          <div className="md:col-span-2 md:col-start-7">
            <h3 className="text-brand-brass font-bold text-[10px] uppercase tracking-[0.3em] mb-10">Expertise</h3>
            <ul className="space-y-6 text-xs font-semibold uppercase tracking-[0.2em] text-brand-offwhite/60">
              <li><Link to="/advisory" className="hover:text-brand-brass transition-colors duration-300">Tier 1 Advisory</Link></li>
              <li><Link to="/services" className="hover:text-brand-brass transition-colors duration-300">Services</Link></li>
              <li><Link to="/liquidity" className="hover:text-brand-brass transition-colors duration-300">Liquidity</Link></li>
              <li><Link to="/analog-village" className="hover:text-brand-brass transition-colors duration-300">Analog Village</Link></li>
            </ul>
          </div>
          
          <div className="md:col-span-3 md:col-start-10">
            <h3 className="text-brand-brass font-bold text-[10px] uppercase tracking-[0.3em] mb-10">Inquiry</h3>
            <ul className="space-y-6 text-xs font-semibold uppercase tracking-[0.2em] text-brand-offwhite/60">
              <li>
                <a
              ...
              <li><Link to="/pricing" className="hover:text-brand-brass transition-colors duration-300">Pricing Logic</Link></li>
              <li><Link to="/contact" className="hover:text-brand-brass transition-colors duration-300">Consultation</Link></li>
            </ul>
          </div>
        </div>
